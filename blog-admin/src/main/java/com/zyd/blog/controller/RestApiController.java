...
public class RestApiController {
    ...
    public ResponseVO<Object> uploadFile(@RequestParam("file") MultipartFile file) {
    ...
    public ResponseVO<Object> notice(String msg) throws UnsupportedEncodingException {
